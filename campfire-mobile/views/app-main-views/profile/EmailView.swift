...
//  campfire-mobile
//
//  Created by Adarsh G on 8/15/23.
//
...
class MailComposeController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    let toEmails = ["support@campfire.co"] // PUT EMAILS HERE
    let fromEmail = "adgadepalli2003@gmail.com" // YOUR EMAIL HERE
...
struct EmailView: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> MailComposeController {
        return MailComposeController()
    }

    func updateUIViewController(_ uiViewController: MailComposeController, context: Context) {

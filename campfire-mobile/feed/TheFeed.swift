...
//                    let player = postModel.postPlayers[index] {
...
////        Binding<Bool>(
////                   get: { self.feedmodel.playingStates[self.postPlayer.postItem.id] ?? false },
////                   set: { self.feedmodel.playingStates[self.postPlayer.postItem.id] = $0 }
////               )
////           }
//
...
//                            }
//                        } else if postPlayer.postItem.numLikes > 0 {

...
extension AuthModel {
    ...
    func createProfile() {
        ...
        let profileData = Profile(name: name, phoneNumber: phoneNumber , email: email, username: self.username, posts: [], prompts: [String](), chocs: 0, userID: userID, school: school, bio: "")
